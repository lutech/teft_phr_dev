...
//    });
    ...
    $("#datatable-icons tbody tr td:last-child").each(function(){
     ...
     /* Formating function for row details */
      ...
      nCloneTd.innerHTML = '<img class="toggle-details" src="' + App.conf.assetsPath + '/teft_phr_prototype/application/content/' + App.conf.imgPath + '/plus.png" />';
      ...
      $('#datatable2').delegate('tbody td img','click', function () {
          ...
          if ( oTable.fnIsOpen(nTr) )
          {
              ...
              this.src = App.conf.assetsPath + '/teft_phr_prototype/application/content/' + App.conf.imgPath + "/plus.png";
              oTable.fnClose( nTr );
          }
          else
          {
