<div id="editAllergy" class="warning colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="allergyName" placeholder="Name/Description" value="Cats">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" id="allergenType" placeholder="Allergen Type">
                                ...
                                <option value="1" selected="selected">Animal</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <select class="form-control js-multiselect" style="text-transform: capitalize;" multiple="multiple" id="reactions">
                                ...
                                <option value="786.2" selected="selected">Cough</option>
                                ...
                                <option value="708.9" selected="selected">Hives (Red, Raised, Itchy Bumps)</option>
                                <option value="786.01">Hyperventilation</option>
                                <option value="780.52">Insomnia</option>
                                <option value="782.0" selected="selected">Itching Or Numbness Or Tingling</option>
                                ...
                                <option value="784.99" selected="selected">Sneezing</option>
