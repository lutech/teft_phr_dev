<div id="editCondition" class="warning colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Edit - Condition/Problem</h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="conditionName" placeholder="Condition/Problem" value="Asthma">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input class="form-control" id="conditionStartDate" placeholder="Start Date" type="date" value="01/01/1995">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="conditionDeterminedBy" placeholder="Determined By" value="Dr. Stewart Jennings">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input class="form-control" id="dateConditionObserved" placeholder="Date Observed" type="date" value="02/08/2015">
                        </div>
                    </div>
                    <div class="form-group">
