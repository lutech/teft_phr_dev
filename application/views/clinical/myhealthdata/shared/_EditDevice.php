<div id="editDevice" class="warning colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Edit - Medical/Assistive Device</h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="deviceName" placeholder="Device Name" value="Hearing Aid">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="anatomicLocation" class="col-xs-3 control-label">Anatomic Location</label>
                        <div class="col-xs-5">
                            <input class="form-control" id="anatomicLocation" placeholder="ex: Arm or Chest" value="Ear">
                        </div>
                    </div>
                    <div class="form-group">
