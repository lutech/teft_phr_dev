<div id="newMedication" class="success colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="medicationDosage" placeholder="Dosage" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" id="medicationFrequency" placeholder="Unit">
                                ...
                                <option value="5">mg (milligram)</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" id="medicationRoute" placeholder="Route">
                                <option value="0">Select a Type</option>
                                <option value="1">By Mouth/Oral</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="medicationPrescribedBy" placeholder="Prescribed By" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="atcNdcCode" placeholder="ATC/NDC Code" value="">
                        </div>
                    </div>
                    <div class="form-group">
