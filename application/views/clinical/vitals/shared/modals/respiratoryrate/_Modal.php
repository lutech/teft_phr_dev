<?php $header = 'Respiratory Rate'; $id = str_replace(' ', '', $header);?>
    <div id="edit<?php echo $id ?>" class="warning colored-header modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
