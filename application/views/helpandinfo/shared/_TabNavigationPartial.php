...
echo new TabMenuItem("Announcements", "#", "", "fa-bullhorn app-icon-circle fa-3x", false,  $this->uri, true);
...
echo new TabMenuItem("LTSS Help Desk", "helpandinfo", "contactus", "fa-phone-square app-icon-circle fa-3x", false,  $this->uri, true);
?>
