...
<div class=" col-md-9">
    <div class="mail-inbox">
        ...
        <div class="filters">
            ...
            <div class="btn-group pull-right">
                <button data-toggle="dropdown" type="button" class="btn btn-sm btn-flat btn-default dropdown-toggle">Order by <span class="caret"></span></button>
        ...
        <div class="mails">
            <div class="item">
                ...
                <div><span class="date pull-right"><i class="fa fa-paperclip"></i> 20 Nov</span>
