<div id="editAddress" class="warning colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="streetaddress1" placeholder="Street Address 1" value="2190 Springs Rd.">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="city" placeholder="City" value=" Aurora">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input class="form-control" id="zipcode" placeholder="Zip Code" value="80010">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" id="county" placeholder="Counties">
                                ...
                                <option value="1" selected="selected">Adams</option>
                    ...
                    <div class="form-group">
                        <label for="primaryAddress" class="col-xs-3 control-label">Primary Address?</label>

                        <div class="col-xs-1">
                            <div class="radio">
                                <label>
                                    <input type="radio" id="primaryAddress" name="primaryAddress" checked="checked"> Yes
                                </label>
                            </div>
                        </div>
                        <div class="col-xs-1">
                            <div class="radio">
                                <label>
                                    <input type="radio" id="primaryAddress" name="primaryAddress"> No
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <textarea class="form-control" id="Description" style="resize: vertical">Nursing Home</textarea>
                        </div>
                    </div>
                </form>
            </div>
