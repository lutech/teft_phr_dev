<div id="editPhone" class="warning colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" id="phone" placeholder="(999) 999-9999" type="tel" value="(720) 859-8799">
                        </div>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-1">
                            <div class="radio">
                                <label>
                                    <input type="radio" id="primaryPhone" name="primaryPhone" checked="checked"> Yes
                                </label>
                            </div>
                        </div>
                        <div class="col-xs-1">
