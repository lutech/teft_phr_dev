<div id="newEmail" class="success colored-header modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" id="email" placeholder="john.doe@email.com" type="email" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-1">
                            <div class="radio">
                                <label>
                                    <input type="radio" id="primaryEmail" name="primaryEmail"> Yes
                                </label>
                            </div>
                        </div>
                        <div class="col-xs-1">
