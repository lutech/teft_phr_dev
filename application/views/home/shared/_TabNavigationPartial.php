...
echo new TabMenuItem("Messages", "home", "messages", "fa-envelope-o app-icon-circle fa-2x", false,  $this->uri, false);
echo new TabMenuItem("Events", "home", "events", "fa-calendar app-icon-circle fa-2x", false,  $this->uri, false);
